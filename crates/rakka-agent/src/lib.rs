...
pub use checkpoints::{
    ...
    AgentCheckpointResolutionReport, AgentCheckpointResult, AgentCheckpointStatus,
    AgentCheckpointTimerOutcome, AgentCompensationRef, AgentReconciliationDecision,
    AgentRecordedDecision, AGENT_CHECKPOINT_APPLIED_KEY_CAPACITY,
