//! Rakka runtime and gRPC server bootstrap.
...
use crate::generated::counter_api::counter_service_server::CounterServiceServer;
use crate::generated::counter_api::{CounterOperation, CounterValue};
use crate::support::{
...
pub async fn run() -> ExampleResult<()> {
    ...
    // The public API is gRPC/protobuf, and Rakka remoting also needs to know
    // how to serialize the operation and reply payloads for cross-node asks.
    ...
    let grpc = CounterGrpc::new(sharding, key, ask_client);
