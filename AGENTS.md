...
- MSRV is Rust `1.88` from the workspace manifest; `rust-toolchain.toml` uses stable with `clippy` and `rustfmt`. gRPC/protobuf crates and examples require `protoc`.
